...
function displayInfo(){
    ...
    document.getElementById("cabin-filter").innerHTML+="<br>Cabin/Pollen Filter needs replacing after 30,000 km / 2 years whichever comes first."
    document.getElementById("brake-fluid").innerHTML+="<br>It is recommended to change your brake fluid every 48,000 km / 2 years whichever comes first."
